...
void makeRequest() async {
  var url = Uri.parse('https://futures.mexc.com/api/v1/private/stoporder/open_orders');  // Adjust API endpoint
  ...
  var data = {
    ...
    'quantity': (1000 * 100 / 95000).toString(),  // Calculate the quantity to buy
    'leverage': '100',  // 100x leverage
    'stop_loss': '94000',  // Stop-Loss at $94,000
    'take_profit': '97000',  // Target Profit at $97,000
