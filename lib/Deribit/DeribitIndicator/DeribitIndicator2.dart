...
class DeribitIndicator3 extends StatefulWidget {
  final String? timeFrameSmall, timeFrameLarge;
  DeribitIndicator3({this.timeFrameSmall = '1', this.timeFrameLarge = '15'});

  @override
  _DeribitIndicator3State createState() => _DeribitIndicator3State();
}

class _DeribitIndicator3State extends State<DeribitIndicator3>{
          ...
          if (mounted) {
            setState(() {
              ...
              if ([2, 5, 10, 15, 20, 25, 32, 40, 45, 50, 55].contains(now.second)) {
                ...
                print(' sar values $sarValuesSmall');
          ...
          child: candlesSmall.isEmpty
            ...
            children: [
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    Expanded(flex: 3, child: buildOHLCChart(candlesSmall, candlesSmall2, smaValuesSmall, smaValuesSecondSmall, sarValuesSmall, 30, 20, 2.0)), // Main OHLC Chart
                    SizedBox(height: 5,),
  ...
  Widget buildOHLCChart(
    ...
    double minY = allCandles.map((c) => c.low).reduce((a, b) => a < b ? a : b) - 0.0001;
    double maxY = allCandles.map((c) => c.high).reduce((a, b) => a > b ? a : b) + 0.0001;
...
// Helper to extract Bollinger Band spots
  ...
  Widget buildOtherData(List<CandleDataMy> candles, smaVolume, List<double> adxValues) {
    return LineChart(
      LineChartData(
        lineBarsData: [
          LineChartBarData(
