...
import 'dart:convert';
import 'dart:io';
import 'package:arbitrage_trading/Deribit/DeribitIndicator/BTCETHONLY/DeribitIndicator1LongFrame.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:fl_chart/fl_chart.dart';


class DeribitIndicator extends StatefulWidget {
  final String? timeFrameSmall, timeFrameLarge;
  DeribitIndicator({this.timeFrameSmall = '1', this.timeFrameLarge = '15'});

  @override
  _DeribitIndicatorState createState() => _DeribitIndicatorState();
}

class _DeribitIndicatorState extends State<DeribitIndicator>{
  ...
  String _timeString = "";
  DeribitIndicator1LongFrame deribitIndicator1LongFrame = DeribitIndicator1LongFrame();
        ...
        if (data['result'] != null) {
          ...
          if (mounted) {
            setState(() {
              ...
              smaValuesSecondSmall = calculateSMA(ohlcData, 3);
          ...
          child: candlesSmall.isEmpty
            ...
            children: [
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    Expanded(flex: 3, child: buildOHLCChart(candlesSmall, smaValuesSmall, smaValuesSecondSmall, sarValuesSmall, 30)), // Main OHLC Chart
                    SizedBox(height: 5,),
              ...
              //   child: Column(
              //     children: [
              //       Expanded(flex: 2, child: buildOtherData(candlesSmall)), // Main OHLC Chart
              //     ],
              //   ),
              // ),
            ],
